...
<div class="view row show-project" style="position: relative; z-index: 100;" id="brand-sprints-section">
  <div class="sidebar column" data-ix="sidebar" id="sidebar-work">
    ...
    <a href="./work/alcide" class="sidebar-project-link" id="alcide-FF0000">alcide</a>
    <a href="./work/darna" class="sidebar-project-link" id="darna-2a52cf">darna</a>
    ...
    <a href="./work/flume" class="sidebar-project-link" id="flume-FF6E15">flume</a>
    ...
    <a href="./work/iceberg" class="sidebar-project-link" id="iceberg-EC7926">iceberg</a>
    <a href="./work/karma" class="sidebar-project-link" id="karma-FCAC8B">karma</a>
    <a href="./work/larosh" class="sidebar-project-link" id="larosh-C0815F">larosh</a>
    <a href="./work/le_salon" class="sidebar-project-link" id="le_salon-000000">le salon</a>
    ...
    <a href="./work/tagbox" class="sidebar-project-link" id="tagbox-C2A78D">tagbox</a>
    ...
    <a href="./work/unleash" class="sidebar-project-link" id="unleash-BE8DF6">unleash</a>
...
<div class="projects">
  ...
  <img src="./work/alcide/0.png" class="sidebar-project-image" id="alcide" loading="lazy"></img>
  <img src="./work/darna/0.png" class="sidebar-project-image" id="darna" loading="lazy"></img>
  ...
  <img src="./work/flume/0.png" class="sidebar-project-image" id="flume" loading="lazy"></img>
  ...
  <img src="./work/iceberg/0.png" class="sidebar-project-image" id="iceberg" loading="lazy"></img>
  <img src="./work/karma/0.png" class="sidebar-project-image" id="karma" loading="lazy"></img>
  <img src="./work/larosh/0.png" class="sidebar-project-image" id="larosh" loading="lazy"></img>
  <img src="./work/le_salon/0.png" class="sidebar-project-image" id="le_salon" loading="lazy"></img>
  <img src="./work/mesh_payments/0.png" class="sidebar-project-image" id="mesh_payments" loading="lazy"></img>
  ...
  <img src="./work/tagbox/0.png" class="sidebar-project-image" id="tagbox" loading="lazy"></img>
  ...
  <img src="./work/unleash/0.png" class="sidebar-project-image" id="unleash" loading="lazy"></img>
  <img src="./work/zigi/0.png" class="sidebar-project-image" id="zigi" loading="lazy"></img>
  <img src="./work/zoog/0.png" class="sidebar-project-image" id="zoog" loading="lazy"></img>
</div>
      `;

      class UnderSidebar extends HTMLElement {
        constructor() {
            super();
            this.innerHTML = TEMPLATE;
        }
    }
    customElements.define("under-sidebar", UnderSidebar);
